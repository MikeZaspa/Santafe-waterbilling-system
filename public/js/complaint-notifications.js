(function (window, $) {
    ...
    function ensureStyles() {
        ...
        style.textContent = [
            ...
            '  background: #fff;',
            '}',
            '.complaint-notification-list::-webkit-scrollbar {',
            '  width: 8px;',
            '}',
            '.complaint-notification-list::-webkit-scrollbar-track {',
            '  background: #eef2f6;',
            '}',
            '.complaint-notification-list::-webkit-scrollbar-thumb {',
            '  background-color: #94a3b8;',
            '  border-radius: 10px;',
            '  border: 2px solid #eef2f6;',
            '}',
            '.complaint-notification-list::-webkit-scrollbar-thumb:hover {',
