    ...
    public function store(Request $request)
{
    $validated = $request->validate([
        ...
        'meter_no' => 'required|string|min:5|max:12|regex:/^[\d-]+$/|unique:admin_consumers',
   ...
   public function update(Request $request, AdminConsumer $adminConsumer)
{
    $validated = $request->validate([
        ...
        'meter_no' => 'required|string|min:5|max:12|regex:/^[\d-]+$/|unique:admin_consumers,meter_no,'.$adminConsumer->id,
