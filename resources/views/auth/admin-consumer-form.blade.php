...
<div id="sidebar" class="sidebar">
    ...
    <nav id="sidebarMenu" class="sidebar-menu">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a id="accountsLink" class="nav-link active" href="admin-consumer-form">
...
<script>
 $(document).ready(function() {
    ...
    columns: [
        { 
            data: null,
            name: 'id', // Changed name to 'id' for clarity, but it's not used for ordering
        ...
        { 
            data: 'consumer', 
            name: 'consumer.last_name', // This is a real column path for ordering/searching
        ...
        { 
            data: 'username', 
            name: 'username' // This is a real column
        },
        { 
            data: 'email', 
            name: 'email' // This is a real column
        },
        { 
            data: null, 
            name: 'password',
    ...
    responsive: true,
    // Set the default order to use the consumer's last name (index 1)
    order: [[1, 'asc']] 
});
